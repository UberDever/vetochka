...
Status: OBSOLETE where it contradicts `tasks/20260805-162236/2026-08-30.md` and
`tasks/20260830-165615/binders.md` — notably: Layer 3 specialization (no specialize stage
