...
Copyright (C) 2024-2026 uberdever

- Code: [GPL-3.0-or-later](LICENSE).
- Documentation (`docs/`) and design records (`tasks/`): [CC BY 4.0](LICENSE-DOCS).
- Code generated by Vetochka is not covered by the project license.
- Vendored files in `reducer/vendor/` keep their own licenses, stated in each file.
- Third-party documents in `docs/smart/` belong to their authors and are not covered.
