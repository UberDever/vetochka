...
1. This session has been taking 3 or so months and then I arrived at conclusion (see the entry at `17.02.2026` in [project history](tasks/20260201-183604/project_history.md)) that I need to do a deep dive into calculus itself
