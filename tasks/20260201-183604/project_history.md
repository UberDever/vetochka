...
- Inside: series of sugared bindings of the form
    See [`artifacts/scope_syntax_example.md`](../20241225-140425/scope_syntax_example.md)
...
- ~~Nesting of modules can be added as a syntax sugar, but I don't see if it's necessary. Right now modules
    ...
    the inner module
    See [`artifacts/module_nesting_example.md`](../20241225-140425/module_nesting_example.md)
- All modules can be used as follows:
    See [`artifacts/module_use_example.md`](../20241225-140425/module_use_example.md)
...
- `use` brings in top-level declarations (i.e. let bindings) into the scope of the expression
    ...
    See [`artifacts/module_name_clash_example.md`](../20241225-140425/module_name_clash_example.md)
- The `module` can be described as a syntax sugar. It acts as a "statement" that doesn't return
    ...
    See [`artifacts/module_syntax_sugar_example.md`](../20241225-140425/module_syntax_sugar_example.md)
...
See [`artifacts/internal_tagging_approach.md`](../20250123-091611/internal_tagging_approach.md)
...
See [`artifacts/native_tagging_approach.md`](../20250123-091611/native_tagging_approach.md)
...
- example for wisp
See [`artifacts/wisp_syntax_example.md`](../20241220-144435/wisp_syntax_example.md)
---
...
See [`artifacts/vetochka_lambda_example.md`](../20250123-091611/vetochka_lambda_example.md)
...
- an example
See [`artifacts/vetochka_word_count_example.md`](../20241220-144435/vetochka_word_count_example.md)
...
- example
See [`artifacts/vetochka_collections_vec.tree.md`](../20241220-144435/vetochka_collections_vec.tree.md);
Also [`artifacts/vetochka_uniform.tree.md`](../20241220-144435/vetochka_uniform.tree.md)
...
- look ma [new syntax in action](../20241220-144435/newer_syntax.tree.md)
