...
- Done: `LICENSE`, `LICENSE-DOCS`, README license section.
- Open: resolve `docs/smart/*.pdf` (remove or link). Decision (user, 2026-09-24): keep for now, likely remove later.
- Open: permissive carve-out for examples users copy into their programs.
- Open: a runtime-library exception if the compiler ever copies its own code into output.
