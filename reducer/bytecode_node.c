...
cells_node_t bytecode_new_ref2(i16 offset) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_ref8(i64 offset) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_delta0() {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_delta1() {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_delta2() {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value0f(i64 value) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value1f(i64 value) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value2f(i64 value) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value0v(span_byte_t payload) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value1v(span_byte_t payload) {
  cells_node_t node = {0};
...
cells_node_t bytecode_new_value2v(span_byte_t payload) {
  cells_node_t node = {0};
...
error_t bytecode_dereference_node(cells_t* cells, size_t* index, cells_node_t* out_node) {
  while (1) {
...
error_t bytecode_get_left_node(cells_t* cells, size_t* parent_index, cells_node_t* out_node) {
  cells_node_meta_t parent_meta = cells_get_node_meta(cells, *parent_index);
  size_t index = *parent_index + parent_meta.size;
  error_t err = bytecode_dereference_node(cells, &index, out_node);
  if (err != ERROR_SUCCESS) { return err; }
  *parent_index = index;
  return ERROR_SUCCESS;
}

error_t bytecode_get_right_node(cells_t* cells, size_t* parent_index, cells_node_t* out_node) {
  cells_node_meta_t parent_meta = cells_get_node_meta(cells, *parent_index);
