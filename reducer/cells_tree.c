...
error_t cells_tree_builder_build(
    struct cells_tree_builder_t* builder, struct cells_t* cells, size_t* index_out) {
...
size_t cells_new_node0(struct cells_tree_builder_t* builder, struct cells_node_t payload) {
  struct cells_tree_t node = {
...
size_t cells_new_node1(
    struct cells_tree_builder_t* builder, struct cells_node_t payload, size_t left) {
  struct cells_tree_t node = {
      .payload = payload,
...
size_t cells_new_node2(
    struct cells_tree_builder_t* builder, struct cells_node_t payload, size_t left, size_t right) {
  struct cells_tree_t node = {
      .payload = payload,
      .left = {.has_value = true, .value = left},
